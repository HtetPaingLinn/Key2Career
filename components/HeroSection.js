...
const chainDots = [
  ...
  }, // Sydney → Singapore
  {
    ...
    end: { lat: 16.8409, lng: 96.1735 },
  }, // Singapore → Yangon
  {
    start: { lat: 16.8409, lng: 96.1735 },
...
export default function HeroSection() {
  ...
  const handleRoadmapClick = () => {
    if (user && jwt) {
      // User is authenticated, navigate to roadmap
      router.push("/roadmap");
    } else {
  ...
  return (
    <section className="relative w-full min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 flex flex-col items-center justify-center text-center overflow-hidden">
              ...
              {!visible && (
                <div className="flex items-center gap-4 -mr-[130px]">
                  {mounted && jwt && user && user.role === "USER" ? (
                    <div
                      className="relative mr-8 order-first"
                      ref={dropdownRef}
                      key={profileKey}
                    >
                      <button
        ...
        <MobileNav>
          ...
          >
            {navItems.map((item, idx) => (
              <a
                key={`mobile-link-${idx}`}
                href={item.link === "/roadmap" ? "#" : item.link}
                onClick={(e) => {
                  if (item.link === "/roadmap") {
                    e.preventDefault();
                    handleRoadmapClick();
                  }
      ...
      <div className="max-w-5xl mx-auto z-10 relative px-6 pt-24">
        ...
        >
          Transform your career journey with AI-powered tools that create
          winning resumes, prepare you for interviews, and provide personalized
          career roadmaps to accelerate your professional growth.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 max-w-4xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-slate-600 text-sm">
              AI-powered templates that adapt to your industry and experience
              level
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-slate-600 text-sm">
              Practice with industry-specific questions and get real-time
              feedback
            </p>
          </div>
          ...
          >
            ...
            <p className="text-slate-600 text-sm">
              Personalized career guidance with skill development paths and
              growth strategies
            </p>
          </div>
        </div>
