  ...
  return (
    <div
      ...
      <div
        ...
        className={cn(
          "relative w-64 bg-transparent transition-all duration-300 ease-in-out",
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-64 transition-all duration-300 ease-in-out md:flex",
          side === "left"
