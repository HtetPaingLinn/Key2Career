...
export default function AwardsSection({ data, onChange, onAdd, onRemove }) {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold font-lexend mb-4">Awards and Honors</h2>
      {data && data.length > 0 ? (
        data.map((award, idx) => (
          <div key={idx} className="border border-gray-200 rounded-xl p-6 mb-4 relative bg-white shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Certificate of Honor"
                  value={award.title || ""}
              ...
              <div>
                ...
                <input
                  type="text"
                  className="w-full rounded-lg border border-gray-300 px-4 py-3 text-base font-dmsans focus:outline-none focus:ring-2 focus:ring-green-400"
                  placeholder="e.g. Department of Electronic Engineering, YTU"
                  value={award.issuer || award.organization || ""}
            ...
            <div className="mt-4">
              ...
              <textarea
                ...
                placeholder="Describe the award, criteria, or context. e.g. Won the 3rd Prize in Fifth Year Course of BE (Electronic Engineering)"
