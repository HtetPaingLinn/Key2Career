...
export function AppSidebar({
  ...
  useEffect(() => {
    const fetchAdminData = async () => {
      try {
        ...
        const response = await fetch(`http://localhost:8080/api/common/profileData?email=${adminEmail}`, {
          headers: {
  ...
  return (
    <>
      ...
      <AdminManagementModal open={adminModalOpen} onOpenChange={setAdminModalOpen} />
    </>
  );
}
