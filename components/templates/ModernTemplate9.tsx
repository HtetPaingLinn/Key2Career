...
export function ModernTemplate9({ cvData }) {
    ...
    <div className="w-full max-w-4xl mx-auto bg-white shadow-sm border border-gray-200">
      ...
      <div className="bg-white p-8 border-b border-gray-200">
        <div className="text-center">
          <div className="w-20 h-20 bg-gray-100 rounded-full mx-auto mb-4 flex items-center justify-center border-2 border-emerald-500">
          ...
          <p className="text-emerald-700 text-lg mb-4 break-words">{data.personalInfo.title}</p>
              ...
              <div>
                ...
                <div className="space-y-2">
                  {data.technicalSkills.map((skill, index) => (
                    <div key={index} className="text-sm text-gray-700 py-1 border-l-2 border-emerald-500 pl-3 break-words">
                      {skill}
                    </div>
                  ))}
                </div>
                ...
                <div className="space-y-2">
                  {data.awardsAndHonors.map((award, index) => (
                    <div key={index} className="text-sm text-gray-700 leading-relaxed">
                      ...
                      <div className="text-emerald-700 text-xs break-words">{award.issuer}</div>
                      {award.year && (
                ...
                <div>
                  ...
                  {data.education.map((edu, index) => (
                    <div key={index} className="mb-4">
                      ...
                      <p className="text-emerald-700 break-words">{edu.school}</p>
                      {edu.field && (
                ...
                <div>
                  ...
                  {data.projects.map((project, index) => (
                    <div key={index} className="mb-4">
                      ...
                      {project.tech && (
                        <p className="text-emerald-700 text-xs break-words">{project.tech}</p>
                      )}
                      {project.description && (
