...
function FormClient() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Persisted Cloudinary metadata for reliable downloads later
      let cvPublicId = null;
      let cvResourceType = null;
      let cvType = null;
      if (cvFile) {
        setSubmitting(true);
        try {
          ...
          // capture metadata
          cvPublicId = urls.publicId || null;
          cvResourceType = urls.resourceType || null;
          cvType = urls.type || null;
      ...
      const applicationData = {
        ...
        // Persist Cloudinary metadata for accurate future downloads
        cvPublicId: cvPublicId,
        cvResourceType: cvResourceType,
        cvType: cvType,
      };
