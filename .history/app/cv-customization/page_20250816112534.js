...
export default function CVCustomizationPage() {
  ...
  const handleClearAllData = async () => {
    ...
    try {
      // Call API to clear CV data from MongoDB
      ...
      // Handle both success and "no data found" cases as success
      if (result.success || (response.status === 404 && result.error === 'No CV data found for this user')) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      <Dialog open={showClearConfirmModal}>
        <DialogContent
          showCloseButton={false}
          className="backdrop-blur-sm bg-white/90 border-none shadow-2xl max-w-md w-full mx-4 p-0 flex flex-col items-center justify-center"
        >
          <DialogTitle className="sr-only">Confirm Clear All Data</DialogTitle>
          <div className="w-full px-8 py-10">
            <div className="text-center mb-8">
              ...
              <p className="text-sm text-red-600 font-medium">All your personal information, work experience, education, skills, and other CV sections will be permanently deleted from the database.</p>
            </div>
            <div className="flex gap-3">
              <button
                type="button"
